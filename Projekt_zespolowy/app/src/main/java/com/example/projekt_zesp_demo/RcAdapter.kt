...
import com.example.projekt_zesp_demo.databinding.ListItemBinding

class RcAdapter(private val listener: Listener): androidx.recyclerview.widget.ListAdapter<ListItem, RcAdapter.ItemHolder>(ItemComparator()) {
